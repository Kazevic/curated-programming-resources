...
Currently, we're living in a sort of "programming renaissance". Programming and computer science is become more popular then ever -- major initiatives like the [Hour of Code](https://hourofcode.com/us) is popularizing learning programming across the world, and the number of people interested in majoring in computer science is [growing](https://www.bcs.org/articles-opinion-and-research/computer-science-now-the-fastest-growing-degree-subject-new-data-reveals) [exponentially](https://www.bcs.org/articles-opinion-and-research/record-numbers-of-students-choose-computer-science-a-level-in-2022).
...
Python and Java are both languages that are [commonly used to teach programming](https://cacm.acm.org/blogcacm/python-is-now-the-most-popular-introductory-teaching-language-at-top-u-s-universities) to beginners in schools and universities, and so will have a wide variety of resources available to help you learn. They're also both widely used in the industry and so are useful languages to have in your toolbelt.
...
- [Codecademy](https://www.codecademy.com) - offers free online courses in several different languages. However, Codecademy does have a tendency to teach only basic syntax, so you must work through more tutorials after finishing Codecademy. Focuses mainly on web development, Ruby, and Python.
...
- [OpenCulture](https://www.openculture.com/computer_science_free_courses) - similar to all of the above. Video lectures are typically available on iTunes or Youtube. Typically does **not** require you to complete assignments, unlike many other online courses.
- [MIT OpenCourseWare](https://ocw.mit.edu) - static course materials taught at MIT. Unless otherwise noted, most content from this website tends to be very rigorous and fast-paced.
...
- Books (paper):
  - [Sam's Teach Yourself C# 5.0 in 24 Hours](https://www.amazon.com/Sams-Teach-Yourself-5-0-Hours/dp/0672336847) by Scott Dorman  
...
- Online courses:
  - Team Treehouse's [PHP course](https://teamtreehouse.com/features/php) - allows a free 14-day trial, but later requires payment.
...
- Interactive tutorials:
  - [Learn Git Branching](https://pcottle.github.io/learnGitBranching/) - a very visual interactive tutorial starting from the absolute basics with a high emphasis on understanding the internals/what each git command really means.
  - [Try Git](https://try.github.io/levels/1/challenges/1) - an interactive tutorial that teaches basic Git.
- Exercises: N/A
- Video tutorials: N/A
- Books and tutorials (online):
  - [Learn Version Control with Git](https://www.git-tower.com/learn/ebook/command-line/introduction) - an introduction to Git for the absolute beginner (via git-tower).
